...
namespace HitechCraft.WebApplication.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на Размер скина должен быть 1 к 2м (ширина 1:2 высота).
        /// </summary>
        public static string ErrorSkinSize {
            get {
                return ResourceManager.GetString("ErrorSkinSize", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на Имя не может быть email адресом.
        /// </summary>
