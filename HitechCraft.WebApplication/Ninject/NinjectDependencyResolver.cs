...
namespace HitechCraft.WebApplication.Ninject
{
    ...
    public class NinjectDependencyResolver : IDependencyResolver
    {
        ...
        public void AddBindings()
        {
            ...
            this._kernel.Bind(typeof(ICommandHandler<ShopItemAddRandomCommand>)).To(typeof(ShopItemAddRandomCommandHandler));
            ...
            this._kernel.Bind(typeof(ICommandHandler<PMInboxRemoveCommand>)).To(typeof(PMInboxRemoveCommandHandler));
