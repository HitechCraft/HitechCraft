namespace HitechCraft.WebApplication.Mapper
{
    ...
    public class ShopItemEditViewModelToShopItemCreateCommandMapper : BaseMapper<ShopItem, ShopItemCreateCommand>
    {
        public ShopItemEditViewModelToShopItemCreateCommandMapper()
        {
            this.ConfigurationStore.CreateMap<ShopItem, ShopItemCreateCommand>()
